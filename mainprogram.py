...
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Restaurant Management System",fg="steel blue",bd=15)
lblinfo.grid(row=0,column=0)
lblinfo = Label(Tops, font=( 'aria' ,20, ),text=current,fg="steel blue")
...
def Ref():
    ...
    costofmeal = "Rs." + str(( (costoffries +  costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks)))
    ...
    sql = f"insert into restaurant_management_system    	values('{randomRef}','{cof}','{colfries}','{cob}','{cofi}','{cochee}','{codr}','{costofmeal}','{Service}','{PaidTax}','{costofmeal}','{OverAllCost}')"
    print(sql)
...
lblreference = Label(f1, font=( 'aria' ,16, 'bold' ),text="Order No.",fg="steel blue",bd = 15)
